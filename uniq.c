/*
Neel Gandhi-N13176779, Anushka Tawte-N19078112 OS-A1
*/
#include "types.h"
#include "stat.h"
#include "user.h"
...
int main(int argc, char *argv[]) {
    ...
    if(argc <= 1){
        ...
        while ((n = read(fd, buf, sizeof(buf)))>0) {
            /*
                ...
                so we only concate the characters that are read in this iteration of
                the while loop. 
            */
    ...
    */
    ...
    /*
        ...
        we are now reading the entire file first, storing it into a long string that
